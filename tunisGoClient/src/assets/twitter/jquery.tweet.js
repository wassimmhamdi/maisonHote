			...
			$(widget).unbind("tweet:load").bind("tweet:load", function(){
				...
				$.ajax({
					...
					success: function(data, status) {
						...
						list.append($.map(tweets, function(o) { return "<div class=\"tweet\">" + t(s.template, o) + "</div>"; }).join('')).
							children('div:first').addClass('tweet-first').end().
							children('div:odd').addClass('tweet-even').end().
							children('div:even').addClass('tweet-odd');
